...
interface NodeApiService {
    ...
    // La función para crear ventas debe esperar una respuesta simplificada.
    @POST("api/sales")
    suspend fun createSale(@Body saleRequest: SaleRequest): Response<CreateSaleSuccessResponse>
